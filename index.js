...
var utterancesDict = {
  ...
  'chinesePower': ['switch'],
  'chineseLeft': ['left'],
  'chineseLeftNumber': ['left {number}', 'go left {number}'],
  'chineseRight': ['right'],
  'chineseRightNumber': ['right {number}', 'go right {number}'],
  'chineseUp': ['up'],
  'chineseUpNumber': ['up {number}', 'go up {number}'],
  'chineseDown': ['down'],
  'chineseDownNumber': ['down {number}', 'go down {number}'],
  'chineseOk': ['play'],
  'chineseHome': ['home'],
  'chineseBack': ['back'],
